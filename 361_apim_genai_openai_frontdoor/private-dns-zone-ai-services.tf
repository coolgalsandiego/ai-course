...
resource "azurerm_private_dns_zone_virtual_network_link" "privatelink-cognitiveservices-azure-com" {
  name                  = "privatelink-cognitiveservices-azure-com"
  resource_group_name   = azurerm_private_dns_zone.privatelink-cognitiveservices-azure-com.resource_group_name
...
resource "azurerm_private_dns_zone_virtual_network_link" "privatelink-openai-azure-com" {
  name                  = "privatelink-openai-azure-com"
  resource_group_name   = azurerm_private_dns_zone.privatelink-openai-azure-com.resource_group_name
...
resource "azurerm_private_dns_zone_virtual_network_link" "privatelink-services-ai-azure-com" {
  name                  = "privatelink-services-ai-azure-com"
  resource_group_name   = azurerm_private_dns_zone.privatelink-services-ai-azure-com.resource_group_name
